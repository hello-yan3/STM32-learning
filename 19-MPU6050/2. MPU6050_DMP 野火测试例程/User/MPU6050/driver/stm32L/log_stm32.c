...
/**
 *  @defgroup MSP430_System_Layer MSP430 System Layer  MSP430_System_Layer MSP430 系统层
 *  @brief  MSP430 System Layer APIs. MSP430 系统层 API。
 *          To interface with any platform, eMPL needs access to various
 *          system layer functions.  为了与任何平台对接，eMPL 需要访问各种系统层功能。
 *
 *  @{
 *      @file   log_msp430.c
