 ...
 */
/**
 *  @addtogroup  DRIVERS Sensor Driver Layer		驱动程序 传感器驱动层
 *  @brief       Hardware drivers to communicate with sensors via I2C.		
 * 							 通过 I2C 与传感器通信的硬件驱动程序。
 *
 *  @{
 *      @file       inv_mpu.c
 *      @brief      An I2C-based driver for Invensense gyroscopes.
 *  							  用于 Invensense 陀螺仪的基于 I2C 的驱动程序。
...
#define log_i       // 不需要输出，直接注释
#define log_e       // 不需要输出，直接注释        
