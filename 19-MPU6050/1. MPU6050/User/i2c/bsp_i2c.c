...
void I2cMaster_Init(void) 
{
	...
	//	GPIO_InitStructure.Alternate=SENSORS_I2C_AF;    // I2C使用默认引脚不是复用引脚，无需进行此配置
	...
	I2C_Handle.Init.OwnAddress1     = I2C_OWN_ADDRESS;
	I2C_Handle.Init.OwnAddress2     = I2C_OWN_ADDRESS;     
	/* 初始化I2C */
	HAL_I2C_Init(&I2C_Handle);	

}
/**
  * @brief  Manages error callback by re-initializing I2C.   通过重新初始化 I2C 管理错误回调。
  * @param  Addr: I2C Address    地址：I2C地址
  * @retval None 
  */
...
{
	slave_addr <<= 1;     // HAL库I2C传输从机地址需要左移1位
