...
// 若使用TIM5，滤波必须设置为0，因为TIM5的CHANNEL_1对应PA0
// 该引脚连接一电容，因此，会对方波频率产生影响！
...
/* TIM3通道1输入引脚 */
#define GENERAL_CH_IC_PIN           		      GPIO_PIN_6         
#define GENERAL_CH_IC_GPIO_PORT     		      GPIOC                    
#define GENERAL_CH_IC_GPIO_CLK_ENABLE() 	    __HAL_RCC_GPIOC_CLK_ENABLE()

#define GENERAL_CH_IC_AFIO()                  __HAL_AFIO_REMAP_TIM3_ENABLE()
